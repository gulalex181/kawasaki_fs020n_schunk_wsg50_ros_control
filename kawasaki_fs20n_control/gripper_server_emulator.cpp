...
int main() {
    ...
    serverAddr.sin_port = htons(5222);
    ...
    while (1) {
        ...
        if (client_socket_fd == -1) {
            ...
            while (1) {
                ...
                std::cout << "[GRIPPER EMULATOR SERVER]: Buffer size: " << count_of_bytes << std::endl;
                std::cout << "[GRIPPER EMULATOR SERVER]: Buffer: '" << buffer << "'" << std::endl;
                
                std::string request = std::string(buffer);

                std::cout << "[GRIPPER EMULATOR SERVER]: Request: '" << request << "'" << std::endl;
                ...
                std::cout << "[GRIPPER EMULATOR SERVER]: Response is sent" << std::endl;
...
std::string request_handling(std::string request) {
    ...
    //     std::cout << "[GRIPPER EMULATOR SERVER]: Received command: " << std::endl
